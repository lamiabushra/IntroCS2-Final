...
amtWolf = new.count('Wolf')
amtLeopard = new.count('Leopard')
amtKoala = new.count('Koala')
amtBottlenoseDolphin = new.count('BottlenoseDolphin')

newlist = []
newlist.append(amtWolf)
newlist.append(amtLeopard)
newlist.append(amtKoala)
newlist.append(amtBottlenoseDolphin)

animalnumber = max(newlist)
chanimalnumber = newlist.index(animalnumber)
chanimal = ['Wolf', 'Leopard', 'Koala', 'BottlenoseDolphin']
